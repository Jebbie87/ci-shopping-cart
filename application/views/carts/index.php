...
<?php foreach ($this->cart->contents() as $items): ?>
  ...
  <tr>
  	<td><?php echo anchor(base_url().'carts/'.$items['rowid'], 'Remove', array('class' => 'btn btn-danger')); ?>
...
<?php endforeach; ?>
	...
	<tr>
	  ...
	  <td class="right" style="float:right">$<?php echo $this->cart->format_number($this->cart->total()); ?></td>
	</tr>
